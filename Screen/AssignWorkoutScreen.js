...
const AssignWorkoutScreen = (props) => {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: "#FFFFFF" }}>
      ...
      <View style={{ flex: 0.85, alignItems: "center" }}>
        <TouchableOpacity
          onPress={() =>
            navigation.navigate("AssignPlanTemplateListScreen", {
              groupId:
                props &&
                props.route &&
                props.route.params &&
              ...
              >
                ...
                >
                  ...
                  props.route.params.planTemplateName
                    ? `Selected Plan : ${props.route.params.planTemplateName} ->  ${props.route.params.weekName}`
      ...
      <View style={styles.buttonView}>
        ...
        >
          <Text style={styles.buttonTextStyle}>Assign Workout </Text>
        </TouchableOpacity>
      </View>
      <DropdownAlert
