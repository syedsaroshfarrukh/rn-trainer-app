    ...
    <View style={stylesSidebar.sideMenuContainer}>
      ...
      <DrawerContentScrollView {...props}>
        ...
        <SideBarMenuButton
          ...
          description={"Workout,video etc"}
          route={"WorkoutTemplateScreen"}
          navigation={props}
        />
        <SideBarMenuButton
          imageUrl={NutitionImage}
          title={"Nutition Plan"}
          description={"Diet,notes,calories"}
        ...
        <SideBarMenuButton
          ...
          description={"Sun,Mon,Tue etc"}
          route={"PlanTemplatesScreen"}
          navigation={props}
        />
        <SideBarMenuButton
          imageUrl={ExcerciseImage}
          title={"Excercise"}
          description={"Youtube Videos"}
          route={"ExcerciseListScreen"}
          navigation={props}
        />
        <SideBarMenuButton
          imageUrl={MealsImage}
          title={"Meals"}
          description={"Youtube Videos"}
          route={"MealsListScreen"}
          navigation={props}
        />
        <SideBarMenuButton
          imageUrl={GroupsImage}
          title={"Groups"}
          description={"Members, group chats, news"}
          route={"GroupsScreen"}
          navigation={props}
        />
