...
const WorkoutTemplateExcerciseCard = ({
  title,
  thumbnail,
  videoLink,
  pivot,
  ...
  console.log(pivot === null ? "Null" : pivot);
                ...
                [
                  ...
                  },
                  {
                    ...
                    onPress: () => {
                      ...
                      if (planTemplate === "planTemplate") {
                        planTemplateService
                          .deleteMainExcerciseCard(pivot.type_id)
                          .then((res) => {
                            // setIsLoading(false);
                        ...
                        workoutService
                          .deleteExcerciseMainCard(pivot.type_id)
                          .then((res) => {
                            // setIsLoading(false);
                            // dropDownAlertRef.alertWithType(
                            //   "success",
...
export default WorkoutTemplateExcerciseCard;
